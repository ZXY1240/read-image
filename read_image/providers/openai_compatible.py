...
from read_image.config import openai_thinking_param
...
class OpenAICompatibleProvider(VisionProvider):
    ...
    def _thinking_fields(self, enabled: bool) -> dict[str, Any]:
        ...
        if style == "auto":
            style = "enable_thinking" if self.model.lower().startswith("qwen") else "thinking"
    ...
    def build_payload(
        ...
        payload.update(self._thinking_fields(profile.thinking_enabled))
